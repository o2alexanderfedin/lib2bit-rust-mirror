        ...
        if !(unsafe { (*(*tb).cl).chrom }).is_null() {
            {
                i = 0 as u32;
                '__b0: loop {
                    if !(i < unsafe { (*(*tb).hdr).n_chroms }) { break '__b0; }
                    '__c0: loop {
                        if !(unsafe {
                                            *unsafe { (*(*tb).cl).chrom.add(i as usize) }
                                        }).is_null() {
                            unsafe {
                                free(unsafe {
                                            *unsafe { (*(*tb).cl).chrom.add(i as usize) }
...
pub(crate) extern "C" fn twobit_index_destroy(tb: &TwoBit) -> () {
    ...
    if !((*tb).idx).is_null() {
        ...
        if !(unsafe { (*(*tb).idx).n_block_start }).is_null() {
            {
                i = 0 as u32;
                '__b1: loop {
                    if !(i < unsafe { (*(*tb).hdr).n_chroms }) { break '__b1; }
                    '__c1: loop {
                        if !(unsafe {
        ...
        if !(unsafe { (*(*tb).idx).n_block_sizes }).is_null() {
            {
                i = 0 as u32;
                '__b2: loop {
                    if !(i < unsafe { (*(*tb).hdr).n_chroms }) { break '__b2; }
                    '__c2: loop {
                        if !(unsafe {
        ...
        if !(unsafe { (*(*tb).idx).mask_block_count }).is_null() {
            unsafe {
                free(unsafe { (*(*tb).idx).mask_block_count } as *mut ())
            };
        }
        if !(unsafe { (*(*tb).idx).mask_block_start }).is_null() {
            {
                i = 0 as u32;
                '__b3: loop {
                    if !(i < unsafe { (*(*tb).hdr).n_chroms }) { break '__b3; }
                    '__c3: loop {
                        if !(unsafe {
            ...
            unsafe {
                free(unsafe { (*(*tb).idx).mask_block_start } as *mut ())
            };
        }
        if !(unsafe { (*(*tb).idx).mask_block_sizes }).is_null() {
            {
                i = 0 as u32;
                '__b4: loop {
                    if !(i < unsafe { (*(*tb).hdr).n_chroms }) { break '__b4; }
                    '__c4: loop {
                        if !(unsafe {
            ...
            unsafe {
                free(unsafe { (*(*tb).idx).mask_block_sizes } as *mut ())
            };
        }
...
pub(crate) extern "C" fn twobit_hdr_destroy(tb: &TwoBit) -> () {
    if !((*tb).hdr).is_null() { unsafe { free((*tb).hdr as *mut ()) }; }
}
...
pub(crate) extern "C" fn twobit_read(data: &mut [u8], nmemb: u64,
    tb: &mut TwoBit) -> u64 {
    if !((*tb).data).is_null() {
        if unsafe {
                    __builtin___memcpy_chk(data.as_ptr() as *mut (),
                        unsafe { (*tb).data.add((*tb).offset as usize) } as
                            *const (), nmemb.wrapping_mul(data.len() as u64),
                        unsafe {
                            __builtin_object_size(data.as_ptr() as *const (), 0)
                        })
                } == 0 as *mut () {
            return 0 as u64;
        }
        (*tb).offset =
            (*tb).offset.wrapping_add(nmemb.wrapping_mul(data.len() as u64) as
                    u64);
        return nmemb;
    } else {
        return unsafe {
                fread(data.as_ptr() as *mut (), data.len() as u64, nmemb,
                    (*tb).fp)
            };
    }
}
...
pub(crate) extern "C" fn twobit_hdr_read(tb: *mut TwoBit) -> () {
    unsafe {
        ...
        let hdr: *mut TwoBitHeader =
            unsafe {
                    calloc(1 as u64,
                        core::mem::size_of::<TwoBitHeader>() as u64)
                } as *mut TwoBitHeader;
        '__b5: loop {
            '__c5: loop {
                ///Read the first 16 bytes
                let mut data: [u32; 4] = [0; 4];
                if (hdr).is_null() as i32 != 0 { return; }
                if twobit_read(unsafe {
                                let __p = &raw mut data[0 as usize] as *mut u8 as *mut u8;
                                if __p.is_null() {
                                    &mut []
                                } else { core::slice::from_raw_parts_mut(__p, 4 as usize) }
                            }, 4 as u64, unsafe { &mut *tb }) != 4 as u64 {
                    break '__b5;
                }

                ///Magic
                unsafe { (*hdr).magic = data[0 as usize] };
                if unsafe { (*hdr).magic } != 440477507 as u32 {
                    unsafe {
                        fprintf(__stderrp,
                            c"[twobitHdrRead] Received an invalid file magic number (0x%x)!\n".as_ptr()
                                    as *mut i8 as *const i8, unsafe { (*hdr).magic })
                    };
                    break '__b5;
                }

                ///Version
                unsafe { (*hdr).version = data[1 as usize] };
                ...
                ///Sequence Count
                unsafe { (*hdr).n_chroms = data[2 as usize] };
        ...
        if !(hdr).is_null() { unsafe { free(hdr as *mut ()) }; }
    }
}
    ...
    loop {
        ...
        '__s7:
            ...
            match __state {
                0 => { __state = 3; }
                2 => {
                    if !(str).is_null() { __state = 32; } else { __state = 31; }
                }
                3 => { __state = 4; }
                4 => { str = 0 as *mut () as *mut i8; __state = 5; }
                5 => {
                    cl =
                        unsafe {
                                calloc(1 as u64, core::mem::size_of::<TwoBitCL>() as u64)
                            } as *mut TwoBitCL;
                    __state = 6;
                }
                6 => {
                ...
                7 => {
                    unsafe {
                        (*cl).chrom =
                            unsafe {
                                    calloc(unsafe { (*unsafe { (*tb).hdr }).n_chroms } as u64,
                        ...
                        (*cl).offset =
                            unsafe {
                                    malloc((core::mem::size_of::<u32>() as
                                                u64).wrapping_mul(unsafe {
                                                    (*unsafe { (*tb).hdr }).n_chroms
                                                } as u64))
                                } as *mut u32
                    };
                    __state = 10;
                ...
                12 => { __state = 2; }
                13 => { i = 0 as u32; __state = 16; }
                14 => { __state = 2; }
                15 => { unsafe { (*tb).cl = cl }; __state = 29; }
                16 => {
                ...
                17 => {
                    if twobit_read(unsafe {
                                    ...
                                    if __p.is_null() {
                                        &mut []
                                    } else { core::slice::from_raw_parts_mut(__p, 1 as usize) }
                                }, 1 as u64, unsafe { &mut *tb }) != 1 as u64 {
                        __state = 20;
                    } else { __state = 19; }
                }
                18 => {
                ...
                22 => {
                    if twobit_read(unsafe {
                                ...
                                }, byte as u64, unsafe { &mut *tb }) != byte as u64 {
                        __state = 25;
                    } else { __state = 24; }
                }
                23 => { __state = 2; }
                ...
                25 => { __state = 2; }
                26 => { str = 0 as *mut () as *mut i8; __state = 27; }
                27 => {
                    if twobit_read(unsafe {
                                    let __p =
                                        unsafe { unsafe { (*cl).offset.add(i as usize) } } as
                                                *mut u8 as *mut u8;
                                    if __p.is_null() {
                                        &mut []
                                    } else {
                ...
                30 => { __state = 2; }
                31 => {
                    if !(cl).is_null() { __state = 33; } else { __state = 1; }
                }
                32 => { unsafe { free(str as *mut ()) }; __state = 31; }
                33 => {
                ...
                36 => { unsafe { free(cl as *mut ()) }; __state = 1; }
                37 => { i = 0 as u32; __state = 39; }
                38 => {
                ...
                40 => {
                    if !(unsafe {
                                        *unsafe { (*cl).chrom.add(i as usize) }
                                    }).is_null() {
                        __state = 42;
                    } else { __state = 41; }
                }
                ...
                42 => {
                    unsafe {
                        free(unsafe { *unsafe { (*cl).chrom.add(i as usize) } } as
                                *mut ())
                    };
                    __state = 41;
                }
...
pub(crate) extern "C" fn twobit_seek(tb: &mut TwoBit, offset: u64) -> i32 {
    ...
    if !((*tb).data).is_null() {
        (*tb).offset = offset;
        return 0;
    } else { return unsafe { fseek((*tb).fp, offset as i64, 0) }; }
}
...
pub(crate) extern "C" fn twobit_tell(tb: &TwoBit) -> u64 {
    if !((*tb).data).is_null() { return (*tb).offset; }
...
pub(crate) extern "C" fn twobit_index_read(tb: *mut TwoBit,
    store_masked_1: i32) -> () {
    let mut i: u32 = 0 as u32;
    ...
    loop {
        ...
        '__s9:
            ...
            match __state {
                0 => { __state = 3; }
                2 => {
                    if !(idx).is_null() { __state = 71; } else { __state = 1; }
                }
                3 => {
                    idx =
                        unsafe {
                                calloc(1 as u64,
                                    core::mem::size_of::<TwoBitMaskedIdx>() as u64)
                ...
                5 => {
                    unsafe {
                        (*idx).size =
                            unsafe {
                                    malloc((unsafe { (*unsafe { (*tb).hdr }).n_chroms } as
                ...
                18 => { __state = 2; }
                19 => {
                    if (unsafe { (*idx).mask_block_count }).is_null() as i32 !=
                            0 {
                        __state = 21;
                    } else { __state = 20; }
                }
                ...
                22 => {
                    unsafe {
                        (*idx).offset =
                            unsafe {
                                    malloc((unsafe { (*unsafe { (*tb).hdr }).n_chroms } as
                                                u64).wrapping_mul(core::mem::size_of::<u64>() as u64))
                                } as *mut u64
                    };
                    __state = 29;
                }
                ...
                25 => {
                    if (unsafe { (*idx).mask_block_start }).is_null() as i32 !=
                            0 {
                        __state = 27;
                    } else { __state = 26; }
                }
                26 => {
                    if (unsafe { (*idx).mask_block_sizes }).is_null() as i32 !=
                            0 {
                        __state = 28;
                    } else { __state = 22; }
                }
                ...
                30 => { i = 0 as u32; __state = 33; }
                31 => { __state = 2; }
                32 => { unsafe { (*tb).idx = idx }; __state = 69; }
                33 => {
                    if i < unsafe { (*unsafe { (*tb).hdr }).n_chroms } {
                        __state = 34;
                    } else { __state = 32; }
                ...
                36 => {
                    if twobit_read(unsafe {
                                ...
                                }, 2 as u64, unsafe { &mut *tb }) != 2 as u64 {
                        __state = 39;
                    } else { __state = 38; }
                }
                37 => { __state = 2; }
                38 => {
                    unsafe {
                        *unsafe { (*idx).size.add(i as usize) } = data[0 as usize]
                    };
                    __state = 40;
                }
                39 => { __state = 2; }
                40 => {
                    unsafe {
                        *unsafe { (*idx).n_block_count.add(i as usize) } =
                            data[1 as usize]
                    };
                    __state = 41;
                }
                41 => {
                    unsafe {
                        *unsafe { (*idx).n_block_start.add(i as usize) } =
                            unsafe {
                                    malloc((unsafe {
                                                    *unsafe { (*idx).n_block_count.add(i as usize) }
                                                } as u64).wrapping_mul(core::mem::size_of::<u32>() as u64))
                                } as *mut u32
                    };
                    __state = 42;
                }
                42 => {
                    unsafe {
                        *unsafe { (*idx).n_block_sizes.add(i as usize) } =
                            unsafe {
                                    malloc((unsafe {
                                                    *unsafe { (*idx).n_block_count.add(i as usize) }
                                                } as u64).wrapping_mul(core::mem::size_of::<u32>() as u64))
                ...
                46 => {
                    if twobit_read(unsafe {
                                    let __p =
                                        unsafe { *unsafe { (*idx).n_block_start.add(i as usize) } }
                                                as *mut u8 as *mut u8;
                                    if __p.is_null() {
                                        &mut []
                                    } else {
                ...
                48 => {
                    if twobit_read(unsafe {
                                    let __p =
                                        unsafe { *unsafe { (*idx).n_block_sizes.add(i as usize) } }
                                                as *mut u8 as *mut u8;
                                    if __p.is_null() {
                                        &mut []
                                    } else {
                ...
                55 => {
                    unsafe {
                        *unsafe { (*idx).mask_block_start.add(i as usize) } =
                            unsafe {
                                    malloc((unsafe {
                                                    *unsafe { (*idx).mask_block_count.add(i as usize) }
                                                } as u64).wrapping_mul(core::mem::size_of::<u32>() as u64))
                ...
                57 => {
                    unsafe {
                        *unsafe { (*idx).mask_block_sizes.add(i as usize) } =
                            unsafe {
                                    malloc((unsafe {
                                                    *unsafe { (*idx).mask_block_count.add(i as usize) }
                                                } as u64).wrapping_mul(core::mem::size_of::<u32>() as u64))
                ...
                67 => {
                    unsafe {
                        *unsafe { (*idx).offset.add(i as usize) } =
                ...
                91 => {
                    unsafe {
                        free(unsafe { (*idx).mask_block_count } as *mut ())
                    };
                    __state = 90;
                }
                92 => {
                ...
                106 => { unsafe { free(idx as *mut ()) }; __state = 1; }
                107 => {
...
#[allow(unused_doc_comments)]
pub(crate) extern "C" fn twobit_open(fname: *const i8, store_masked_1: i32)
    -> *mut TwoBit {
    let tb: *mut TwoBit =
        unsafe { calloc(1 as u64, core::mem::size_of::<TwoBit>() as u64) } as
            *mut TwoBit;
    '__b10: loop {
        '__c10: loop {
            let mut fd: i32 = 0;
            ...
            unsafe {
                (*tb).fp =
                    unsafe {
                        fopen(fname as *const i8,
                            c"rb".as_ptr() as *mut i8 as *const i8)
                    }
            };
            if (unsafe { (*tb).fp }).is_null() as i32 != 0 { break '__b10; }
            ...
            if unsafe { fstat(fd, &mut fs) } == 0 {
                ...
                unsafe {
                    (*tb).data =
                        unsafe {
                            mmap(0 as *mut (), fs.st_size as u64, 1, 1, fd, 0 as OffT)
                        }
                };
                if !(unsafe { (*tb).data }).is_null() {
                    if unsafe {
                                madvise(unsafe { (*tb).data }, fs.st_size as u64, 1)
                            } != 0 {
            ...
            twobit_hdr_read(tb);
            if (unsafe { (*tb).hdr }).is_null() as i32 != 0 { break '__b10; }

            ///Read in the chromosome list
            twobit_chrom_list_read(tb);
            if (unsafe { (*tb).cl }).is_null() as i32 != 0 { break '__b10; }

            ///Read in the mask index
            twobit_index_read(tb, store_masked_1);
            if (unsafe { (*tb).idx }).is_null() as i32 != 0 { break '__b10; }
            return tb;
            break '__c10;
        }
...
pub(crate) extern "C" fn twobit_chrom_len(tb: &TwoBit, chrom: *const i8)
    -> u32 {
    let mut i: u32 = 0 as u32;
    {
        i = 0 as u32;
        '__b11: loop {
            if !(i < unsafe { (*(*tb).hdr).n_chroms }) { break '__b11; }
            '__c11: loop {
                if unsafe {
                            strcmp(unsafe {
                                        *unsafe { (*(*tb).cl).chrom.add(i as usize) }
                                    } as *const i8, chrom as *const i8)
                        } == 0 {
                    return unsafe {
                            *unsafe { (*(*tb).idx).size.add(i as usize) }
                        };
                }
                break '__c11;
            }
...
#[allow(unused_doc_comments)]
pub(crate) extern "C" fn bytes2bases(seq: *mut i8, byte: *const u8, sz: u32,
    mut offset: i32) -> () {
        ...
        while offset < 4 && pos < sz {
            unsafe {
                *seq.add({
                    ...
                    byte2base(foo,
                        { let __p = &mut offset; let __t = *__p; *__p += 1; __t })
            };
        }
        if pos >= sz { return; }
        foo =
    ...
    while pos < sz.wrapping_sub(remainder) {
        ...
        unsafe {
            *seq.add(pos.wrapping_add(3 as u32) as usize) =
                bases[(foo as i32 & 3) as usize]
        };
        foo >>= 2;
        unsafe {
            *seq.add(pos.wrapping_add(2 as u32) as usize) =
                bases[(foo as i32 & 3) as usize]
        };
        foo >>= 2;
        unsafe {
            *seq.add(pos.wrapping_add(1 as u32) as usize) =
                bases[(foo as i32 & 3) as usize]
        };
        foo >>= 2;
    ...
    if remainder > 0 as u32 { foo = unsafe { *byte.add(i as usize) }; }
    {
        offset = 0;
        '__b14: loop {
            if !((offset as u32) < remainder) { break '__b14; }
            '__c14: loop {
                unsafe {
                    *seq.add({
                                        let __p = &mut pos;
...
pub(crate) extern "C" fn n_mask(seq: *mut i8, tb: &TwoBit, tid: u32,
    start: u32, end: u32) -> () {
    let mut i: u32 = 0 as u32;
    ...
    let mut block_end: u32 = 0 as u32;
    {
        ...
        '__b15: loop {
            if !(i <
                            unsafe {
                                *unsafe { (*(*tb).idx).n_block_count.add(tid as usize) }
                            }) {
                break '__b15;
            }
            '__c15: loop {
                block_start =
                    unsafe {
                        *unsafe {
                                (*unsafe {
                                            (*(*tb).idx).n_block_start.add(tid as usize)
                                        }).add(i as usize)
                            }
                    };
                block_end =
                    block_start.wrapping_add(unsafe {
                            *unsafe {
                                    (*unsafe {
                                                (*(*tb).idx).n_block_sizes.add(tid as usize)
                                            }).add(i as usize)
                                }
                        });
                if block_end <= start { break '__c15; }
                if block_start >= end { break '__b15; }
...
pub(crate) extern "C" fn soft_mask(seq: *mut i8, tb: &TwoBit, tid: u32,
    start: u32, end: u32) -> () {
    let mut i: u32 = 0 as u32;
    let mut width: u32 = 0 as u32;
    let mut pos: u32 = 0 as u32;
    ...
    }
    {
        ...
        '__b17: loop {
            if !(i <
                            unsafe {
                                *unsafe { (*(*tb).idx).mask_block_count.add(tid as usize) }
                            }) {
                break '__b17;
            }
            '__c17: loop {
                block_start =
                    unsafe {
                        *unsafe {
                                (*unsafe {
                                            (*(*tb).idx).mask_block_start.add(tid as usize)
                                        }).add(i as usize)
                            }
                    };
                block_end =
                    block_start.wrapping_add(unsafe {
                            *unsafe {
                                    (*unsafe {
                                                (*(*tb).idx).mask_block_sizes.add(tid as usize)
                                            }).add(i as usize)
                                }
                        });
                if block_end <= start { break '__c17; }
                if block_start >= end { break '__b17; }
                if block_start < start {
                    block_end = if block_end < end { block_end } else { end };
                    pos = 0 as u32;
                    width = block_end.wrapping_sub(start);
...
#[allow(unused_doc_comments)]
pub(crate) extern "C" fn construct_sequence(tb: *mut TwoBit, tid: u32,
    start: u32, end: u32) -> *mut i8 {
    let sz: u32 = end.wrapping_sub(start).wrapping_add(1 as u32);
    let seq: *mut i8 =
        unsafe {
                malloc((sz as
                            u64).wrapping_mul(core::mem::size_of::<i8>() as u64))
            } as *mut i8;
    ...
    '__b19: loop {
        '__c19: loop {
            ...
            if (seq).is_null() as i32 != 0 { return 0 as *mut () as *mut i8; }
            ...
            block_end =
                (end /
                        4 as
                            u32).wrapping_add(if end % 4 as u32 != 0 { 1 } else { 0 } as
                        u32);
            bytes =
                unsafe { malloc(block_end.wrapping_sub(block_start) as u64) }
                    as *mut u8;
            if (bytes).is_null() as i32 != 0 { break '__b19; }
            if twobit_seek(unsafe { &mut *tb },
                        unsafe {
                            (*unsafe {
                                        (*unsafe { (*tb).idx }).offset.add(tid as usize)
            ...
            bytes2bases(seq, bytes as *const u8, sz.wrapping_sub(1 as u32),
                offset);
            unsafe { free(bytes as *mut ()) };

            ///Null terminate the output
            unsafe {
                *seq.add(sz.wrapping_sub(1 as u32) as usize) =
                    '\u{0}' as i32 as i8
            };
    ...
    if !(seq).is_null() { unsafe { free(seq as *mut ()) }; }
    if !(bytes).is_null() { unsafe { free(bytes as *mut ()) }; }
...
pub(crate) extern "C" fn twobit_sequence(tb: *mut TwoBit, chrom: *const i8,
    start: u32, mut end: u32) -> *mut i8 {
    let mut i: u32 = 0 as u32;
    let mut tid: u32 = 0 as u32;
    {
        ...
        '__b20: loop {
            ...
            '__c20: loop {
                if unsafe {
                            strcmp(unsafe {
                                        *unsafe { (*unsafe { (*tb).cl }).chrom.add(i as usize) }
                                    } as *const i8, chrom as *const i8)
                        } == 0 {
                    tid = i;
                    break '__b20;
    ...
    if start == end && end == 0 as u32 {
            ...
            unsafe {
                *unsafe { (*unsafe { (*tb).idx }).size.add(tid as usize) }
            };
    }
    if end >
            unsafe {
    ...
    if start >= end { return 0 as *mut () as *mut i8; }
...
pub(crate) extern "C" fn get_mask(tb: &TwoBit, tid: u32, start: u32, end: u32,
    mask_idx_1: &mut u32, mask_start_1: &mut u32, mask_end_1: &mut u32)
    -> () {
            ...
            *mask_idx_1 = 0 as u32;
            '__b22: loop {
                ...
                '__c22: loop {
                    ...
                    *mask_end_1 =
                        (*mask_start_1).wrapping_add(unsafe {
                                *unsafe {
                                        (*unsafe {
                                                    (*(*tb).idx).n_block_sizes.add(tid as usize)
                                                }).add(*mask_idx_1 as usize)
                    ...
                    if *mask_end_1 < start { break '__c22; }
                    if *mask_end_1 >= start { break '__b22; }
                    break '__c22;
                }
                {
...
#[allow(unused_doc_comments)]
pub(crate) extern "C" fn twobit_bases_worker(tb: *mut TwoBit, tid: u32,
    mut start: u32, end: u32, fraction: i32) -> *mut () {
    ...
    loop {
        ...
        '__s24:
            ...
            match __state {
                0 => { __state = 3; }
                2 => {
                    if !(out).is_null() { __state = 89; } else { __state = 88; }
                }
                3 => {
                    len =
                        end.wrapping_sub(start).wrapping_add(start % 4 as u32);
                    i = 0 as u32;
                    j = 0 as u32;
                    __state = 4;
                }
                4 => { seq_len = end.wrapping_sub(start); __state = 5; }
                5 => { mask_idx = -1i32 as u32; __state = 6; }
                6 => {
                ...
                7 => {
                    if fraction != 0 { __state = 9; } else { __state = 10; }
                }
                8 => {
                ...
                11 => { block_start = start / 4 as u32; __state = 13; }
                12 => { return 0 as *mut (); }
                13 => { offset = (start % 4 as u32) as u8; __state = 14; }
                14 => {
                    block_end =
                        (end /
                                4 as
                ...
                15 => {
                    bytes =
                        unsafe {
                                malloc(block_end.wrapping_sub(block_start) as u64)
                            } as *mut u8;
                    __state = 16;
                }
                16 => {
                ...
                23 => { __state = 2; }
                24 => {
                    get_mask(unsafe { &*tb }, tid, start, end, &mut mask_idx,
                        &mut mask_start, &mut mask_end);
                    __state = 26;
                }
                25 => { __state = 2; }
                26 => { if i < len { __state = 28; } else { __state = 27; } }
                27 => { unsafe { free(bytes as *mut ()) }; __state = 77; }
                28 => {
                ...
                30 => {
                    if start.wrapping_add(i) >= mask_start ||
                            start.wrapping_add(i).wrapping_add(4 as
                                            u32).wrapping_sub(offset as u32) > mask_start {
                        __state = 31;
                    } else { __state = 29; }
                }
                31 => {
                    if start.wrapping_add(i) >= mask_start &&
                            start.wrapping_add(i).wrapping_add(4 as
                                            u32).wrapping_sub(offset as u32) < mask_end {
                        __state = 33;
                    } else { __state = 32; }
                }
                32 => {
                    foo =
                        (4 as
                                    u32).wrapping_mul(j).wrapping_add((4 as
                                    u32).wrapping_mul(block_start));
                    __state = 41;
                }
                33 => { i = mask_end.wrapping_sub(start); __state = 34; }
                34 => {
                    get_mask(unsafe { &*tb }, tid, i, end, &mut mask_idx,
                        &mut mask_start, &mut mask_end);
                    __state = 35;
                }
                35 => {
                ...
                36 => { j = i / 4 as u32; __state = 37; }
                37 => {
                    mask = get_byte_mask_from_offset(offset as i32);
                    __state = 38;
                }
                38 => { i = (4 as u32).wrapping_mul(j); __state = 39; }
                39 => { offset = 0 as u8; __state = 40; }
                40 => { __state = 26; }
                41 => {
                    if mask as i32 & 1 != 0 &&
                ...
                43 => { mask = mask.wrapping_sub(1 as u8); __state = 42; }
                44 => {
                    if mask as i32 & 4 != 0 &&
                ...
                45 => { mask = mask.wrapping_sub(2 as u8); __state = 44; }
                46 => {
                    if mask as i32 & 8 != 0 &&
                            (foo >= mask_start && foo < mask_end) {
                        __state = 49;
                    } else { __state = 48; }
                }
                47 => { mask = mask.wrapping_sub(4 as u8); __state = 46; }
                48 => {
                    if foo.wrapping_add(4 as u32) > mask_end {
                        __state = 50;
                    } else { __state = 29; }
                }
                49 => { mask = mask.wrapping_sub(8 as u8); __state = 48; }
                50 => {
                    get_mask(unsafe { &*tb }, tid, i, end, &mut mask_idx,
                        &mut mask_start, &mut mask_end);
                    __state = 51;
                ...
                55 => { mask = mask.wrapping_sub(1 as u8); __state = 54; }
                56 => {
                    if mask as i32 & 4 != 0 && i.wrapping_add(1 as u32) >= len {
                        __state = 59;
                    } else { __state = 58; }
                }
                57 => { mask = mask.wrapping_sub(2 as u8); __state = 56; }
                58 => {
                    if mask as i32 & 8 != 0 && i >= len {
                        __state = 60;
                    } else { __state = 52; }
                }
                59 => { mask = mask.wrapping_sub(4 as u8); __state = 58; }
                60 => { mask = mask.wrapping_sub(8 as u8); __state = 52; }
                61 => {
                    if mask as i32 & 1 != 0 {
                        __state = 63;
                    } else { __state = 62; }
                }
                62 => { foo >>= 2 as u32; __state = 64; }
                63 => {
                    {
                ...
                64 => { mask >>= 1; __state = 65; }
                65 => {
                    if mask as i32 & 1 != 0 {
                        __state = 67;
                    } else { __state = 66; }
                }
                66 => { foo >>= 2 as u32; __state = 68; }
                67 => {
                    {
                        let __p = &mut tmp[(foo & 3 as u32) as usize];
                        let __t = *__p;
                ...
                68 => { mask >>= 1; __state = 69; }
                69 => {
                    if mask as i32 & 1 != 0 {
                        __state = 71;
                    } else { __state = 70; }
                }
                70 => { foo >>= 2 as u32; __state = 72; }
                71 => {
                    {
                        let __p = &mut tmp[(foo & 3 as u32) as usize];
                        let __t = *__p;
                ...
                72 => { mask >>= 1; __state = 73; }
                73 => {
                    if mask as i32 & 1 != 0 {
                        __state = 75;
                    } else { __state = 74; }
                }
                74 => { i = i.wrapping_add(4 as u32); __state = 76; }
                75 => {
                    {
                        let __p = &mut tmp[(foo & 3 as u32) as usize];
                        let __t = *__p;
                ...
                76 => { mask = 15 as u8; __state = 26; }
                77 => {
                    if fraction != 0 { __state = 79; } else { __state = 80; }
                }
                78 => { return out; }
                79 => {
                    unsafe {
                ...
                80 => {
                    unsafe {
                        *(out as *mut u32).offset(0 as isize) = tmp[2 as usize]
                    };
                    __state = 84;
                }
                81 => {
                ...
                84 => {
                    unsafe {
                        *(out as *mut u32).offset(1 as isize) = tmp[1 as usize]
                    };
                    __state = 85;
                }
                85 => {
                    unsafe {
                        *(out as *mut u32).offset(2 as isize) = tmp[0 as usize]
                    };
                    __state = 86;
                }
                86 => {
                    unsafe {
                        *(out as *mut u32).offset(3 as isize) = tmp[3 as usize]
                    };
                    __state = 78;
                }
                87 => { __state = 2; }
                ...
                89 => { unsafe { free(out) }; __state = 88; }
                90 => { return 0 as *mut (); }
                91 => { unsafe { free(bytes as *mut ()) }; __state = 90; }
                _ => {}
            }
        }
    }
...
pub(crate) extern "C" fn twobit_bases(tb: *mut TwoBit, chrom: *const i8,
    start: u32, mut end: u32, fraction: i32) -> *mut () {
    let mut tid: u32 = 0 as u32;
    let mut i: u32 = 0 as u32;
    {
        i = 0 as u32;
